<template>
    <f7-popover class="exist_pop_over">
        ...
        <f7-block inner>
            <f7-list form>
                <f7-list-item radio name="select_object" v-for="(item,index) in list" :key="index" :title="item.name" @change="Chagne_item(item,index)" @selected="selecte_item"></f7-list-item>
